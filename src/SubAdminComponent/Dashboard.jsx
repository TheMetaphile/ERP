  ...
  return (
    <div className="w-screen h-screen overflow-x-auto  no-scrollbar ">
      ...
      <div className="flex flex-grow  mobile:max-tablet:pt-16">
        ...
        <div className={`mobile:max-laptop:absolute mobile:max-laptop:right-0 rounded-lg shadow-md flex-shrink-0 bg-white transition-all duration-300 pt-20 mobile:max-laptop:${isEndDrawerOpen ? 'w-60 h-full' : 'w-0 h-0'} laptop:w-60 laptop:h-full overflow-y-auto no-scrollbar`}>
          <SubAdminEndDrawer />
        </div>
      </div>
