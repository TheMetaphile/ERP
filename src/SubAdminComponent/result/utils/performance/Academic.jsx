...
export default function Academic() {
    ...
    return (
        <div className={`w-full shadow-md rounded-lg tablet:p-4 mobile:max-tablet:px-2 mt-4 ${
            darkMode 
                ? 'bg-gray-800 border border-gray-700 text-gray-200' 
                : 'border border-gray-300'
        }`}>
            <div className={`border-t-2 my-3 tablet:mx-2 rounded-full ${
                darkMode ? 'border-blue-400' : 'border-text_blue'
            }`}></div>
            <div className='w-full flex items-center justify-between px-3'>
                <h1 className={`tablet:text-3xl mobile:max-tablet:text-xl font-medium text-center ${
                    darkMode ? 'text-blue-400' : 'text-text_blue'
                }`}>Academic Performance</h1>
                <h1 className={`flex items-center text-sm p-2 rounded-lg shadow-md self-end ${
                    darkMode ? 'bg-gray-700 text-gray-200' : 'bg-secondary'
            ...
            <div className='flex flex-col w-full justify-between tablet:mx-2 mobile:max-tablet:overflow-auto'>
                ...
                <div className="w-full mobile:max-tablet:w-fit tablet:mx-2">
                    ...
                    <div className={`rounded-lg shadow-md tablet:mr-5 border-2 ${
