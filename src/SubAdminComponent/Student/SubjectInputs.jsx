    ...
    <div className={`w-full ${darkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'} rounded-lg shadow-md p-6 mb-6`}>
      ...
      <div className="flex flex-wrap mb-4">
        {subjects.map((subject, index) => (
          <div 
            key={index} 
            className={`flex items-center mr-3 mb-3 rounded-full ${
              darkMode 
          ...
          >
            ...
            <div
              className={`flex items-center justify-center w-5 h-5 rounded-full ${
                darkMode ? 'text-indigo-300 hover:bg-indigo-700' : 'text-indigo-600 hover:bg-indigo-200'
      ...
      <div className="flex items-end">
        <div className="flex-grow mr-4">
          <label 
            className={`block text-sm font-medium ${darkMode ? 'text-gray-300' : 'text-gray-700'} mb-1 whitespace-nowrap`} 
        ...
        <div
          className={`inline-flex items-center mobile:max-tablet:px-1 mobile:max-tablet:py-1 whitespace-nowrap px-4 py-2 border border-transparent cursor-pointer text-sm font-medium rounded-md shadow-sm text-white ${
