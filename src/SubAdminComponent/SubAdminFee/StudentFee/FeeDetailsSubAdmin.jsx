    ...
    return (
        ...
        <div className="flex flex-col px-6 py-8 mobile:max-tablet:p-2">
            ...
            <div className='flex justify-between items-center mb-8 mobile:max-tablet:flex-col'>
                <h1 className="text-3xl font-bold text-blue-500 flex items-center mobile:max-tablet:text-lg whitespace-nowrap"><MdSchool className="mr-2" />Student Fee Details</h1>
