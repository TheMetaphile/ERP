    ...
    return (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-50 " >
            <div className="bg-white p-6 rounded shadow-lg tablet:w-1/2 mobile:max-tablet:mx-4">
                ...
                <button onClick={handleDownloadReceipt} className="bg-white-300 border border-black p-2 hover:bg-blue-500 hover:text-white hover:border-white  rounded mb-4 flex items-center gap-1"><span><MdOutlineFileDownload className=" h-6 w-6" />
                ...
                <table className="w-full border-collapse mt-4 rounded-sm mobile:max-tablet:overflow-auto">
                    <thead>
                        <tr className=" bg-blue-200 rounded-sm">
                ...
                <div className="mt-4 flex items-center justify-between gap-2">
                    ...
                    <button onClick={onClose} className="bg-white px-10 hover:bg-blue-500 hover:text-white border-black hover:border-white border py-2 rounded mt-4">Back</button>
