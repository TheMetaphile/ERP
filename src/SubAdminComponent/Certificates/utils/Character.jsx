        ...
        <div className="tablet:max-laptop:max-w-xl pt-4 px-60 w-full">
            <div className="w-full justify-center">
                ...
                <div className='flex justify-between'>
                    <div className="text-xl font-medium mb-4 justify-center w-fit rounded-lg shadow-md py-1 px-3 mt-3 bg-blue-200 text-black hover:bg-blue-300 cursor-pointer hover:text-white" onClick={handleDownload}>
                        Download
                    </div>
                    <div className="text-xl font-medium mb-4 justify-center w-fit rounded-lg shadow-md py-1 px-3 mt-3 bg-blue-200 text-black hover:bg-blue-300 cursor-pointer hover:text-white" onClick={fetchUserCc}>
                        Reset
                    </div>
                </div>
