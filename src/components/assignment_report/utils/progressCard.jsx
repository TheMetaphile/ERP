...
export default function ProgressCard(props) {
  return (
    <div className="w-52 mobile:max-tablet:w-full mobile:max-tablet:h-52 border border-gray-300 bg-white shadow-md rounded-lg mr-2 p-4 flex flex-col items-center justify-center">
