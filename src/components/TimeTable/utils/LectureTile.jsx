                ...
                {lectures.map((lecture) => (
                    lecture.lectureNo === index + 1 ? (
                        <div key={lecture._id} className="w-full flex">
                            <h1 className=" w-96 px-4 py-2 text-center border-r border-gray-400 bg-green-200">{lecture.lectureNo}</h1>
                            ...
                            <div className="w-full px-4 py-2 text-center border-r flex items-center border-gray-400 bg-blue-200">
                                ...
                                <p className="text-sm px-2 whitespace-nowrap">{lecture.teacher.name}</p>
                            </div>
