...
export default function HomeWorkGrid(){
    return (
        <div className=" tablet:max-laptop:grid  laptop:grid tablet:max-laptop:grid-cols-2 laptop:grid-cols-4 tablet:max-laptop:gap-6  tablet:p-2 mobile:max-tablet:px-3">
