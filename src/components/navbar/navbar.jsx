          ...
          <li className="flex items-center space-x-4">
            <div className="relative" ref={dropdownRef}>
              ...
              {isOpen && (
                  ...
                  <div className={`absolute right-0 mt-1 w-40 bg-white rounded-lg shadow-lg  font-medium text-black ${darkMode
                    ? 'bg-gray-700 text-white border border-gray-600'
                    : 'bg-white text-gray-800 border border-gray-200'
                    }`}>
                    <Link
                      to="/Student-Dashboard/profile"
                      className={`block px-4 py-3 font-medium hover:transition-colors rounded-t-lg duration-200 text-black  ${darkMode
                        ? 'hover:bg-gray-400'
                        : 'hover:bg-blue-200'
                        }`}
                    >
                    ...
                    <button
                      onClick={logout}
                      className={`block w-full text-left px-4 py-2 hover:bg-blue-300 rounded-b-lg text-black ${darkMode
                        ? 'hover:bg-gray-400'
                        : 'hover:bg-blue-200'
                        }`}
