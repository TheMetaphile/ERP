export default function SubjectClassWorkTile(props){
    return (
        <div className=" w-full p-3 border border-gray-300 mt-2 rounded-lg shadow-md">
            <div className="flex justify-between mobile:max-tablet:flex-col ">
                <div className=" px-3 py-1 bg-bg_blue rounded-full border border-gray-300 w-fit">{props.subject}</div>
