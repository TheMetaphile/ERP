...
export default function ClassWorkGrid(){
    return (
        <div className="tablet:max-laptop:grid border border-gray-300 laptop:grid tablet:max-laptop:grid-cols-2 laptop:grid-cols-4 tablet:max-laptop:gap-6 rounded-lg shadow-md tablet:p-4 mobile:max-tablet:px-3">
