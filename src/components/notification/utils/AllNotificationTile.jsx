    ...
    return (
        <div className="w-full">
            {details.map((detail, index) => (
                <div key={index} className=" w-full p-2  rounded-lg border border-gray-300 shadow-md mt-3 flex items-center mobile:max-laptop:flex flex-col">
                    ...
                    <div className='px-2 w-11/12'>
                        ...
                        <div className='flex gap-2 mobile:max-tablet:gap-0'>
