...
export default function InternalTile(props) {
    return (
        <div className="border border-gray-300 p-3 tablet:mr-2 mobile:max-tablet:mb-3 rounded-lg shadow-md mt-2">
            ...
            <Link to={`${props.subject}`}><div className="w-fit px-3 py-1 m-auto mt-3 bg-bg_blue rounded-full border border-gray-300 shadow-md">Take Test</div></Link>
