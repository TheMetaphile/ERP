  ...
  return (
    <div className="flex flex-col items-center mobile:max-tablet:w-fit border-b border-gray-200 ">
      {/* <div key={index} className="whitespace-nowrap flex items-center w-full border-b border-gray-300 ">
          <h5 className="text-gray-500 font-normal w-96 text-center border-r border-gray-300 h-full py-2">{paymentDetails.installment_id}</h5>
          <h5 className="text-gray-500 font-normal w-32 text-center border-r border-gray-300 h-full py-2">{paymentDetails.order_id}</h5>
          <h5 className="text-gray-500 font-normal w-96 text-center border-r border-gray-300 h-full py-2">{paymentDetails.payment_id}</h5>
          <h5 className="text-gray-500 font-normal w-60 text-center border-r border-gray-300 h-full py-2">{paymentDetails.date}</h5>
          <h5 className="text-gray-500 font-normal w-24 text-center border-r border-gray-300 h-full py-2">{paymentDetails.amount}</h5>
          <h5 className="text-gray-500 font-normal w-28 text-center border-r border-gray-300 h-full py-2">{paymentDetails.payment_status}</h5>
