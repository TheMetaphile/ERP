export default function FeeStructureHeader() {
    return (
        <div className="bg-aquamarine w-full   flex justify-between rounded-t-lg border-b border-gray-300   whitespace-nowrap">
            ...
            <h4 className="w-20 text-center border-r border-gray-300 h-full py-2">Discount</h4>
            <h4 className="w-32 text-center border-r border-gray-300 h-full py-2 whitespace-nowrap">Payable Amount</h4>
