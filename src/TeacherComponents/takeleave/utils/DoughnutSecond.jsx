...
export default function DoughnutSecond({ chartData, title }) {
  ...
  return (
    <div className="flex flex-col h-full w-full mobile:max-tablet:w-full justify-evenly items-center shadow-lg bg-teal-100 border border-gray-300 rounded-lg px-4 ">
