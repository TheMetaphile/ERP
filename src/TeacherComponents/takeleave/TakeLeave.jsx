...
function TakeLeave() {
    ...
    return (
        <motion.div
            className="flex flex-col px-6 h-screen overflow-y-auto items-start mt-4 mb-6 no-scrollbar bg-blue-50"
        ...
        >
            ...
            <motion.div className='w-full flex items-center justify-between mb-6 py-2' variants={itemVariants}>
                <h1 className='text-3xl font-bold text-blue-600'>Your Leave</h1>
                <motion.button
