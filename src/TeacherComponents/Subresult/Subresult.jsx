    ...
    return (
        <div className="p-2 w-full">
            <div className="flex justify-between items-center mb-4 mobile:max-tablet:flex-col mobile:max-tablet:items-start">
                <h1 className='text-xl mobile:max-tablet:text-lg font-medium text-blue-400'>{profile.name} Progress Report</h1>
            ...
            <div className="report-card border border-black " ref={ref} >
                        ...
                        {details[selectedTermValue].length === 0 ? (
                            ...
                            <div className=' overflow-auto'>
                                <table className="min-w-full border border-gray-200">
                                    <thead className=' bg-gradient-to-r from-blue-200 to-blue-100 text-xl font-medium whitespace-nowrap  '>
                ...
                <div className=' border-b border-black'>
                    <div className="flex mobile:max-tablet:flex-col mobile:max-tablet:text-sm mobile:max-tablet:items-start  bg-gradient-to-r from-blue-200 to-blue-100 text-xl items-center justify-between px-4 pb-4">
