      ...
      <div className="flex mobile:max-sm:flex-col mobile:max-sm:items-start  items-center justify-between cursor-pointer" onClick={() => handleClick(index)}>
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <div className="flex items-center text-sm text-indigo-600 whitespace-nowrap">
        ...
        {expanded === index && (
          ...
          >
            ...
            <div className="mt-4">
              ...
              <textarea
                className="w-full px-3 py-2 mb-2 border border-indigo-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="flex items-center justify-center w-full p-2 bg-indigo-600 text-white rounded-lg shadow-md"
...
export default function NewDoubtTile({ data, Class }) {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-2xl mobile:max-tablet:text-sm font-bold text-indigo-800">Pending Doubts</h2>
        <div className="flex items-center bg-indigo-600 mobile:max-tablet:p-2 mobile:max-tablet:text-xs text-white px-4 py-2 rounded-lg shadow-md">
