...
export default function ClassTeacherSubstitute(){
    ...
    return (
        ...
        <div className="flex justify-between">
          <h1 className="text-xl font-medium mb-2 mobile:max-tablet:text-lg">Class teachers on leave (Today)</h1>

        </div>
        <ClassTeacherOnLeaveTable />
        <div className="flex justify-between">
          <h1 className="text-xl font-medium mt-3 mb-2 mobile:max-tablet:text-lg">Class teachers substitution history</h1>
