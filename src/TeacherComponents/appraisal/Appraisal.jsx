...
function Appraisal() {
  ...
  return (
    <div className=" flex flex-col px-3 mobile:max-tablet:px-0  items-start mt-2 mb-3">
      <ToastContainer />
      <h1 className='text-3xl'>Appraisal</h1>
        ...
        <div className=" flex   ml-3 mr-3 items-center justify-between">
          <div className=" flex  gap-2 mt-2">
            ...
            <Link
              ...
              className={`text-xl font-medium px-2 rounded-lg py-1 ${selectedLink === '/Teacher-Dashboard/appraisal/applied' ? 'bg-secondary ' : 'bg-gray-300'}`}
            ...
            <Link
              ...
              className={`text-xl font-medium px-2 rounded-lg  py-1 ${selectedLink === '/Teacher-Dashboard/appraisal/apply' ? 'bg-secondary ' : 'bg-gray-300'}`}
