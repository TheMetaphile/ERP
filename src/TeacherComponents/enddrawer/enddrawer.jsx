...
export default function TeacherEnddrawer() {
  return (
    <div className="overflow-y-auto w-full h-full px-2 rounded-lg border mobile:max-tablet:border-t-0 border-gray-300 z-10 mobile:max-laptop:mt-0">
      ...
      <h6 className="flex mt-2 justify-between text-sm overflow-auto no-scrollbar">Your Leaves
        <Link to={'/Teacher-Dashboard/takeleave'}>
          <span className="text-blue-500">See All</span>
        </Link>
      </h6>
      <div className="dialyNotices w-full  bg-blue-50 rounded-xl p-2 mt-2 mb-3 overflow-auto no-scrollbar">
