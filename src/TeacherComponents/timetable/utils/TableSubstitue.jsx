                        ...
                        data.sort((a, b) => a.lectureNo - b.lectureNo).map((item, idx) => {
                            ...
                            <React.Fragment key={item._id}>
                                ...
                                <tr className='text-center border-t border-gray-400'>
                                    ...
                                    <td className="w-60 px-4 py-2 border-r whitespace-nowrap border-gray-400 bg-blue-200">{`${formatTime(Time[item.Lecture - 1].start)}-${formatTime(Time[item.Lecture - 1].end)}`}</td>
