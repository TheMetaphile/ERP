  ...
  return (
    ...
    >
      ...
      <div className='w-full flex items-center justify-between my-2'>
        <div className='flex-1'>
          <motion.h1
            className="mb-2 text-3xl mobile:max-tablet:text-lg font-medium text-black whitespace-nowrap"
            whileHover={{ scale: 1.05 }}
            transition={{ type: 'spring', stiffness: 300 }}
          >
            Upload Report Card
        ...
        <div className="block flex-1 mobile:max-tablet:justify-end justify-end laptop:hidden w-full items-end mobile:max-laptop:text-end">
          <motion.button
            className="p-2 border rounded flex items-center "
            onClick={() => setDropdownVisible(!isDropdownVisible)}
            whileHover={{ scale: 1.05 }}
