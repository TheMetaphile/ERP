...
export default function AcademicMiddleTile({ details }) {
  return (
    <div className="border-b-2 mobile:max-tablet:w-fit w-full px-3">
      {details.term1.length > 0 && (
        <div className="term-section mt-2">
          <h2 className="font-medium text-lg px-3 mb-3">Term 1</h2>
      ...
      {details.term2.length > 0 && (
        <div className="term-section mt-3">
          <h2 className="font-medium text-lg px-3 mb-3">Term 2</h2>
          <AcademicTopTile heading={["Subject", 'Obtained Practical Marks', 'Total Practical Marks', 'Obtained Marks', "Total Marks"]} />
