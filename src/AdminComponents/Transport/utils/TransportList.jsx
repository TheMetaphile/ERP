        ...
        <>
            <div className="flex flex-col">
                <div className="flex justify-between mt-2">
                    ...
                    <div><button className="text-2xl px-4 mobile:max-tablet:mx-4 mx-8 mt-4 mobile:max-tablet:text-xl rounded-lg whitespace-nowrap bg-secondary hover:bg-blue-200" onClick={handleClick}>Add New</button></div>
                </div>
