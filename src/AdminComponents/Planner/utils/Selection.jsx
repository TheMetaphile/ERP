        ...
        <div className="container p-3 w-fit mobile:max-tablet:w-full">
            ...
            <div className="flex justify-between gap-3 mobile:max-tablet:flex-col">
                <div className="w-36 mobile:max-tablet:w-full">
                    <select id="class" className="w-full px-2 py-2 border-2 border-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300 rounded-md" value={selectedClass} onChange={handleClassChange}>
                ...
                <div className="w-36 mobile:max-tablet:w-full">
                    <select id="section" className="w-full px-2 py-2 border-2 border-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300 rounded-md" value={selectedSection} onChange={handleSectionChange}>
                ...
                <div className="w-36 mobile:max-tablet:w-full">
                    <select id="subject" className="w-full px-2 py-2 border-2 border-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300 rounded-md" onChange={handleSubjectChange}>
