                ...
                <div className=" flex ml-3 mr-3 items-center justify-between overflow-auto">
                    <div className=" flex  gap-2 w-full ">
                        <Link to={`/Admin-Dashboard/StudentsFee/structure`} onClick={() => handleLinkSelect('/Admin-Dashboard/StudentsFee/structure')}>
                            <h1 className={`p-2 mx-1 ${selectedLink === '/Admin-Dashboard/StudentsFee/structure' ? "text-gray-600 border-b-2 border-blue-400" : "text-gray-600"}`}>
                                Fee Structure
                            </h1>
                        </Link>
                        <Link to={`/Admin-Dashboard/StudentsFee/details`} onClick={() => handleLinkSelect('/Admin-Dashboard/StudentsFee/details')}>
                            <h1 className={`p-2 mx-1 ${selectedLink === '/Admin-Dashboard/StudentsFee/details' ? "text-gray-600 border-b-2 border-blue-400" : "text-gray-600"}`}>
                                Fee Status
                            </h1>
                        </Link>
                        <Link to={`/Admin-Dashboard/StudentsFee/feediscount`} onClick={() => handleLinkSelect('/Admin-Dashboard/StudentsFee/feediscount')}>
                            <h1 className={`p-2 mx-1 ${selectedLink === '/Admin-Dashboard/StudentsFee/feediscount' ? "text-gray-600 border-b-2 border-blue-400" : "text-gray-600"}`}>
                                Fee Discount
                            </h1>
                        </Link>
                        <Link to={`/Admin-Dashboard/StudentsFee/PreviousFee`} onClick={() => handleLinkSelect('/Admin-Dashboard/StudentsFee/PreviousFee')}>
                            <h1 className={`p-2 mx-1 ${selectedLink === '/Admin-Dashboard/StudentsFee/PreviousFee' ? "text-gray-600 border-b-2 border-blue-400" : "text-gray-600"}`}>
                                Previous Fee
                            </h1>
                        </Link>
                        <Link to={`/Admin-Dashboard/StudentsFee/discountCategory`} onClick={() => handleLinkSelect('/Admin-Dashboard/StudentsFee/discountCategory')}>
                            <h1 className={`p-2 mx-1 ${selectedLink === '/Admin-Dashboard/StudentsFee/discountCategory' ? "text-gray-600 border-b-2 border-blue-400" : "text-gray-600"}`}>
                                Discount Category
                            </h1>
                        </Link>
                        {/* <Link to={`/Admin-Dashboard/StudentsFee/CompleteFee`} onClick={() => handleLinkSelect('/Admin-Dashboard/StudentsFee/CompleteFee')}>
                            <h1 className={`p-2 mx-1 ${selectedLink === '/Admin-Dashboard/StudentsFee/CompleteFee' ? "text-gray-600 border-b-2 border-blue-400" : "text-gray-600"}`}>
                                Complete Fee
                            </h1>
                        </Link> */}
                    </div>
