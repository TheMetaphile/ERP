        ...
        <div className=" flex flex-col px-3  mobile:max-tablet:px-0   items-start mt-2  mb-3 ">
            ...
            <div className=' w-full'>
                <div className=' mt-2  border rounded-lg overflow-auto'>
                    <div className="flex justify-between  py-2  bg-gradient-to-r from-blue-400 to-blue-500 text-white  rounded-t-lg border border-b-2  whitespace-nowrap mobile:max-tan w-full mobile:max-tablet:w-fit">
