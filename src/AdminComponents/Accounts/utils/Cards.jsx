...
const Card = () => {
  return (
    <div className="bg-white p-6 rounded-lg  h-full">
      <div className="flex justify-between space-x-6 mobile:max-laptop:space-x-0  h-full mobile:max-laptop:flex-col mobile:max-laptop:w-full mobile:max-laptop:gap-4">
        <div className="shadow-lg rounded-lg p-4  w-1/3 h-full flex flex-col justify-between bg-yellow-200  mobile:max-laptop:w-full ">
        ...
        <div className="shadow-lg rounded-lg p-4 w-1/3 h-full flex flex-col justify-between bg-yellow-200 mobile:max-laptop:w-full mobile:max-tablet:">
