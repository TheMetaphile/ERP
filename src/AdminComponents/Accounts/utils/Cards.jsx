...
const Card = () => {
  return (
    <div className="bg-white p-6 rounded-lg  h-full">
      <div className="flex justify-between space-x-6 mobile:max-tablet:space-x-2  h-full">
        <div className="shadow-lg rounded-lg p-4  w-1/3 h-full flex flex-col justify-between bg-yellow-200">
