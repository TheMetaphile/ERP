        ...
        <div className=" w-full">
            ...
            <div className="flex tablet:flex-wrap mobile:max-tablet:flex-col w-full mobile:max-tablet:gap-2 mobile:max-tablet:p-2 tablet:w-full tablet:max-laptop:mx-2 tablet:max-laptop:gap-2 tablet:z-0 my-4">
                <input
                    ...
                    className="rounded-lg shadow-md mr-3 mobile:max-tablet:mr-0 px-3 py-1 border-2 border-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300 text-lg flex-1"
                />
                <input
                    type="text"
                    id="name"
                    ...
                    className="rounded-lg shadow-md px-3 py-1 border-2 border-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300 text-lg mr-3 mobile:max-tablet:mr-0 flex-1"
                />
