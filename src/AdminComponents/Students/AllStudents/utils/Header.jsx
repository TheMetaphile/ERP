export default function Header(props) {
    return (
        <div className="flex justify-evenly items-center py-2 pl-2 bg-purple-200 h-fit rounded-t-lg border-b-2 border-black w-full tablet:max-laptop:w-fit  gap-2 tablet:max-laptop:gap-3">
