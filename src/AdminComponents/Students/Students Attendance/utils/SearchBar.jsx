    ...
    return (
        ...
        <div className="flex mobile:max-tablet:flex-col w-full mobile:max-tablet:w-full mobile:max-tablet:gap-2 mobile:max-tablet:p-2 ">
            ...
            <select
                ...
                className="rounded-lg shadow-md mr-3 px-3 py-2 border-2 border-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300 text-lg mobile:max-tablet:mr-0 flex-1"
            >
