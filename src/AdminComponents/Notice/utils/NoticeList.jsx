  ...
  return (
    <div className="mt-8 mx-2">
      <div className="flex justify-between mb-4">
                ...
                <div><button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={handleOpenModal}>Write Notice</button></div>
            </div>
      <div className="">
      ...
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
          <div className="bg-white rounded-lg p-6">
            <h2 className="text-xl font-bold mb-4">Write Notice</h2>
