  ...
  return (
    <div className="bg-white p-4 rounded-lg shadow-md w-full flex flex-col">
      <div className="flex justify-between">
        <div className="flex gap-10  mobile:max-tablet:gap-0">
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
          <div className="bg-white rounded-lg p-6 ">
            ...
            <div className="flex space-x-4 mb-4">
              <button
                className={`px-4 py-2 rounded-lg ${selectedOption === 'Student'
              ...
              <button
                className={`px-4 py-2 rounded-lg ${selectedOption === 'Teacher'
                  ? 'bg-blue-500 text-white'
                  : 'bg-gray-200 text-gray-800'
                  }`}
