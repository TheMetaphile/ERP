  ...
  return (
    <div className="w-screen h-screen overflow-x-auto  no-scrollbar ">
      ...
      <div className="flex flex-grow h-screen pt-20 mobile:max-tablet:pt-32">
        <div className={`mobile:max-tablet:absolute z-20 flex-shrink-0 transition-all duration-300 mobile:max-tablet:mt-8 ${isDrawerOpen ? 'w-60 h-full' : 'w-0'} overflow-y-auto no-scrollbar`}>
          <AdminDrawer isOpen={isDrawerOpen} />
        </div>
        <div className="flex-grow  overflow-y-auto no-scrollbar mobile:max-tablet:mt-10">
          <Outlet />
        </div>
