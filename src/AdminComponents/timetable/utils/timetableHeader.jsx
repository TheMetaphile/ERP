...
export default function TimetableHeader() {
    return (
        <motion.thead
            ...
            className="bg-gradient-to-r from-blue-200 to-blue-100 text-black rounded-t-lg  text-xl w-full"
        >
            <tr>
                {['Lecture', 'Timing', 'Subject', 'Optional', 'Teacher', 'Remark'].map((header, index) => (
                    <th key={index} className="px-4 py-3 text-center border-r border-blue-400 items-center">
