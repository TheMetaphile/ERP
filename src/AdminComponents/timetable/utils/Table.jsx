...
function Table({ data, Time, numberOfLeacturesBeforeLunch }) {
    ...
    return (
        <motion.div
            ...
            className="w-full overflow-auto mt-4 rounded-lg border border-blue-400 shadow-lg "
        >
            <table className="w-full items-center rounded-lg whitespace-nowrap">
                ...
                <tbody>
                    {timetable.length > 0 ? (
                            ...
                            <React.Fragment key={item._id}>
                                {numberOfLeacturesBeforeLunch === item.lectureNo - 1 && (
                                    <motion.tr
                                        ...
                                        className="w-full h-10 bg-blue-200 text-xl text-center font-semibold"
                                    >
                                ...
                                <motion.tr
                                    ...
                                    className='text-center hover:bg-blue-100 transition-colors duration-200'
                                >
                        ...
                        <tr>
                            <td colSpan="5" className="text-center py-6 text-blue-600">No data available</td>
                        </tr>
                    )}
                </tbody>
            </table>
