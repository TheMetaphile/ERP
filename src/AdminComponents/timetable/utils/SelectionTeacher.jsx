      ...
      >
        <div className="container">
          <div className="flex items-center md:flex-row justify-between gap-6">
            ...
            >
              <div className="relative">
                <FaCalendarAlt className="absolute top-3 left-3 text-blue-400" />
                <select
                  className="w-full px-10 py-2 border-2 border-blue-300 rounded-md appearance-none focus:outline-none focus:border-blue-500 transition-colors duration-300"
                  value={day}
