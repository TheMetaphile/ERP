...
const SchoolPerformanceChart = () => {
  ...
  return <div className='h-full mobile:max-laptop:w-full py-2 text-center rounded-lg shadow-md  border border-gray-300'>School Income and Expenses Analysis<canvas ref={chartRef} className=' mb-6  tablet:ml-5 ' /></div>;
};
