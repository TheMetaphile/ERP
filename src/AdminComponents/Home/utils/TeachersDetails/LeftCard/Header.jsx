export default function Header(props) {
    return (
        <div className="flex justify-between items-center py-2 pl-2 bg-bg_blue h-fit rounded-t-lg border-b-2 border-black text-center w-fit mobilemedium:w-full laptop:w-full  gap-2">
