...
class CharacterCertificate extends StatefulWidget {
  const CharacterCertificate({super.key});

  @override
  State<CharacterCertificate> createState() => _CharacterCertificateState();
}

class _CharacterCertificateState extends State<CharacterCertificate> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:   Text("Character Certificate",style: GoogleFonts.openSans(fontSize:size.width*0.055,color:themeObj.textBlack,fontWeight:FontWeight.w600),),
