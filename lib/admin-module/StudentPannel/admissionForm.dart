                    ...
                    Row(
                      ...
                      children: [
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Father's Occupation*",style: GoogleFonts.openSans(fontSize:size.width*0.04,color:Colors.black),),
                            SizedBox(height: size.height*0.01,),
                            Container(
                              width: size.width*0.4,
                              height: size.height*0.055,
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Mother's Occupation*",style: GoogleFonts.openSans(fontSize:size.width*0.04,color:Colors.black),),
                            SizedBox(height: size.height*0.01,),
                            Container(
                              width: size.width*0.4,
                              height: size.height*0.055,
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Blood Group*",style: GoogleFonts.openSans(fontSize:size.width*0.04,color:Colors.black),),
                            SizedBox(height: size.height*0.01,),
                            Container(
                              width: size.width*0.4,
                              height: size.height*0.055,
                    ...
                    Row(
                      ...
                      children: [
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Guardian Name*",style: GoogleFonts.openSans(fontSize:size.width*0.04,color:Colors.black),),
                            SizedBox(height: size.height*0.01,),
                            Container(
                              width: size.width*0.4,
                              height: size.height*0.055,
