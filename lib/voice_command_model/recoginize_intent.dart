...
class CustomIntent {
  ...
  "result": [
  "result", "results", "exam result", "test result", "grade", "grades",
  // # Additional keywords for parents
  "parent result", "parent results", "parent exam result", "parent test result", "parent grade", "parent grades",
  // # Additional keywords for teachers
  "teacher result", "teacher results", "teacher exam result", "teacher test result", "teacher grade", "teacher grades",
  // # Additional keywords for students
  "student result", "student results", "student exam result", "student test result", "student grade", "student grades"
  ],
      ...
      for (var keyword in intent_keywords[intent]!) {
        if (userInput.contains(keyword)) {
          switch (intent) {
            ...
            case "result":
              Speak().speak("Proceeding to display the result.");
              return {"route": "/result", "attributes": {}};
