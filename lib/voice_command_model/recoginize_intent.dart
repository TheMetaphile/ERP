...
class CustomIntent {
  Map<String, dynamic> intent_keywords = {
    ...
    "dashboardIntent": [
      ...
      /// Additional keywords for parents
      "parent dashboard", "parent home", "parent main", "parent overview",
      "parent summary", "parent play quiz",
      "parent view", "parent dashboard view", "parent home page",

      /// Additional keywords for teachers
      "teacher dashboard", "teacher home", "teacher main", "teacher overview",
      "teacher summary", "teacher play quiz",
      "teacher view", "teacher dashboard view", "teacher home page",

      /// Additional keywords for students
      "student dashboard", "student home", "student main", "student overview",
      "student summary", "student play quiz",
      ...
      for (var keyword in intent_keywords[intent]!) {
        if (userInput.contains(keyword)) {
          switch (intent) {
            ...
            case "gallery":
              Speak().speak("Proceeding to display the gallery.");
