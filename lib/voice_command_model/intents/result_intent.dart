...
class ResultIntent{
  Map<String, dynamic> resultIntent(String userInput){
    ...
    if (classMatch == null && sectionMatch == null) {
      Speak().speak("You didn't mention the class and section for which you want to see the resultAPI.dart screen. Please try again.");
    } else {
      if (classMatch == null) {
        Speak().speak("You didn't mention the class for which you want to see the resultAPI.dart screen. Please try again.");
      } else {

        Speak().speak("User wants to see the resultAPI.dart of Class $classValue Section $sectionValue. Proceeding to display the resultAPI.dart screen.");
      }
    }
    return {
      "route": "/resultScreen",
