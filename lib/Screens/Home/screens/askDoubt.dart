...
class AskDoubt extends StatelessWidget {
  AskDoubt({super.key});
  final TextEditingController selectedTeacher = TextEditingController();
  final TextEditingController selectedSubject = TextEditingController();
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Expanded(
                              child: Image.asset("assets/Navigation/Home/AskDoubt2.png"),
                          )
                        ],
                      ),
                    )
