...
class _HomeWorkState extends State<HomeWork>with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //   title: Text("Home Work",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w400,fontSize: size.width*0.06),),
      // ),
                                          ...
                                          child: SizedBox(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                SizedBox(height: size.height*0.02,),
                                                Text("Today Work",style: GoogleFonts.openSans(color:Colors.grey,fontSize:size.width*0.035,fontWeight:FontWeight.w600),),
                                                SizedBox(height: size.height*0.01,),
                                                Text("Essay on BestFriend",style: GoogleFonts.openSans(color:Colors.black,fontSize:size.width*0.04,fontWeight:FontWeight.w400),),
                                                SizedBox(height: size.height*0.02,),
                                                ...
                                                Center(
                                                  child: Container(
                                                    ...
                                                    child: ElevatedButton(
                                                        ...
                                                        onPressed: (){}, child: Text("Edit",style: GoogleFonts.openSans(color:Colors.white),)),
                                                  ),
                                                ),
