...
class _TeacherLeaveState extends State<TeacherLeave>with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchMoreLeavesData() async {
    ...
    try {
      ...
      int? previousLength=teacherLeaves?.length;

        teacherLeaves?.addAll(fetchedLeaves);

      int? newLength=teacherLeaves?.length;
  ...
  PreferredSizeWidget _buildAnimatedAppBar(Size size) {
          ...
          return AppBar(
            ...
            title: AnimatedDefaultTextStyle(
              style: TextStyle(
                ...
                fontSize: size.width * 0.05 * (1 + 0.1 * _animation.value),
              ),
              duration: Duration(milliseconds: 200),
              child: Text("My Leave"),
            ),
            actions: [_buildNewLeaveButton(size)],
          );
        },
      ),
    );
  ...
  Widget _buildNewLeaveButton(Size size) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return Container(
          ...
          child: ElevatedButton(
            onPressed: () => newLeavePopup(context, size),
            style: ElevatedButton.styleFrom(
              backgroundColor: Color.fromRGBO(216, 180, 254, 1),
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30)),
              elevation: 4 + 2 * _animation.value,
            ),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
      ...
      child: SingleChildScrollView(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              SizedBox(height: size.height * 0.02),
              _buildLeaveBalanceCard(size),
              SizedBox(height: size.height * 0.02),
              _buildLeaveHistorySection(size),
            ],
          ),
        ),
      ),
  ...
  Widget _buildLeaveBalanceCard(Size size) {
    return Card(
      elevation: 5,
      shape: RoundedRectangleBorder(
        side: BorderSide(color: themeObj.textgrey, width: 1),
        borderRadius: BorderRadius.circular(12),
      ),
      child: Container(
        padding: EdgeInsets.all(15.0),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            _buildMainProgressIndicator(size),
            SizedBox(height: size.height * 0.02),
            // _buildLeaveBalanceRow(size),
            // SizedBox(height: size.height * 0.02),
            SingleChildScrollView(
          scrollDirection: Axis.horizontal,
          child: Row(
            ...
            children: [
              _buildLeaveTypeCard("Casual", states?["casual"].toString() ?? "0", Colors.blue),
              _buildLeaveTypeCard("Medical", states?["medical"].toString() ?? "0", Colors.red),
              _buildLeaveTypeCard("Earned", states?["earned"].toString() ?? "0", Colors.green),
              _buildLeaveTypeCard("Restricted", states?["restricted"].toString() ?? "0", Colors.blue),
              _buildLeaveTypeCard("Complimentary", states?["complimentary"].toString() ?? "0", Colors.greenAccent),
              _buildLeaveTypeCard("Duty", states?["duty"].toString() ?? "0", Colors.blue),
              _buildLeaveTypeCard("Maternity", states?["maternity"].toString() ?? "0", Colors.purpleAccent),
            ],
          ),
        ),
        ]
  ...
  Widget _buildMainProgressIndicator(Size size) {
  ...
  // Widget _buildLeaveBalanceRow(Size size) {
  //   return Row(
  //     mainAxisAlignment: MainAxisAlignment.spaceBetween,
  //     children: [
  //       _buildLeaveBalanceItem("Leave Used", states?["accepted"].toString() ?? "", size),
  //       _buildLeaveBalanceItem("Total Leave", states?["total"].toString() ?? "", size),
  //     ],
  //   );
  // }

  // Widget _buildLeaveBalanceItem(String label, String value, Size size) {
  //   return Column(
  //     children: [
  //       Text(
  //         value,
  //         style: TextStyle(color: themeObj.textBlack, fontWeight: FontWeight.w600, fontSize: size.width * 0.055),
  //       ),
  //       Text(
  //         label,
  //         style: TextStyle(color: themeObj.textgrey, fontSize: size.width * 0.04),
  //       ),
  //     ],
  //   );
  // }
  ...
  Widget _buildLeaveHistorySection(Size size) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
          "Leaves History",
          style: TextStyle(fontSize: size.width * 0.05, color: themeObj.textBlack),
        ),
        Divider(color: themeObj.textgrey),
        isLoading
            ? Center(
          ...
          child: ListView.builder(
            ...
            itemCount: teacherLeaves?.length ?? 0,
            itemBuilder: (context, index) {
              return AnimationConfiguration.staggeredList(
                ...
                child: SlideAnimation(
                  ...
                  child: FadeInAnimation(
                    child: _buildLeaveHistoryCard(teacherLeaves?[index], size),
                  ),
                ),
              );
            },
  ...
  Widget _buildLeaveHistoryCard(Map<String, dynamic>? leave, Size size) {
    if (leave == null) return SizedBox();
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Icon(Icons.event, color: _getColor("annualLeaves"), size: size.width * 0.04),
                            SizedBox(width: 5),
                            Text(
                              leave["type"],
                              style: GoogleFonts.poppins(
                                color: _getColor("annualLeaves"),
                                fontSize: size.width * 0.035,
                ...
                SizedBox(height: size.height * 0.01),
                if (leave["status"] == "Approved") _buildApprovedBy(leave, size),
              ],
            ),
          ),
        ),
  ...
  Widget _buildLeaveStatus(Map<String, dynamic> leave, Size size) {
    return Column(
      children: [
        Container(
          decoration: BoxDecoration(
            ...
            child: Row(
              children: [
                ...
                _buildActionButton(
                  ...
                  onPressed: () => deleteLeave(leave["_id"]),
                  size: size,
                ),
              ],
            ),
  ...
  Widget _buildActionButton({required IconData icon, required Color color, required VoidCallback onPressed, required Size size}) {
    return SizedBox(
      ...
      child: IconButton(
        ...
        onPressed: onPressed,
        icon: Icon(icon, size: size.width * 0.05, color: Colors.white),
      ),
    );
  }

  Widget _buildApprovedBy(Map<String, dynamic> leave, Size size) {
    return Container(
      padding: EdgeInsets.all(8),
      decoration: BoxDecoration(
