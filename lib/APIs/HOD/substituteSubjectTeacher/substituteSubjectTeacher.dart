...
class SubstituteSubjectTeacherApi{
  ...
  Future<Map<String,dynamic>> absenteeismFetch(String accessToken) async
  {
    ...
    final url = Uri.parse('$baseUrl/LectureSubstitute/fetch/checkLeave?date=2024-07-31&session=$session');
  ...
  Future<Map<String,dynamic>> substitutionLog(String accessToken,int start) async
  {
    ...
    final url = Uri.parse('$baseUrl/LectureSubstitute/fetch/completeHistory?date=$date&session=$session&start=$start&end=10');
