...
import '../../StudentAPIs/NotificationAPI/notificationAPI.dart';
...
import '../Classword/classWork.dart';
                  ...
                  child: Column(
                    children: [
                      ...
                      ListTile(
                        ...
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context) => StudentNoteBookRecord(currentClass: currentClass, section: section,),));
                        },
                      ),
