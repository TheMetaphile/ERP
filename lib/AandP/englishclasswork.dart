...
class EnglishClassWork extends StatefulWidget {
  const EnglishClassWork({super.key, required this.subject});
  final String subject;
  @override
  State<EnglishClassWork> createState() => _EnglishClassWorkState();
}

class _EnglishClassWorkState extends State<EnglishClassWork> {
  @override
                     ...
                     child:Column(
                       ...
                       children: [
                         ...
                         Padding(
                           ...
                           child: AutoSizeText("${widget.subject} Class Work",
                                 ...
                                 children: [
                                   ...
                                   SizedBox(
                                       ...
                                       child: ElevatedButton(
                                           ...
                                           onPressed: (){}, child: AutoSizeText("Download",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600,fontSize: size.height*0.023),))),
                                   SizedBox(
                                     height: size.height*0.02,
                                   ),                               ],
                               ),
